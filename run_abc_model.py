...
def get_dataset(channel_first=True):
    ...
    if not channel_first:
        train_images_norm = train_images_norm[np.logical_and(train_biomasses_norm<=120,train_biomasses_norm>80)]
        train_biomasses_norm = train_biomasses_norm[np.logical_and(train_biomasses_norm<=120,train_biomasses_norm>80)]
    else:
    ...
    if not channel_first:
        validate_images_norm = validate_images_norm[np.logical_and(validate_biomasses_norm<=120,validate_biomasses_norm>80)]
        validate_biomasses_norm = validate_biomasses_norm[np.logical_and(validate_biomasses_norm<=120,validate_biomasses_norm>80)]
    else:
    ...
    if not channel_first:
        test_images_norm = test_images_norm[np.logical_and(test_biomasses_norm<=120,test_biomasses_norm>80)]
        test_biomasses_norm = test_biomasses_norm[np.logical_and(test_biomasses_norm<=120,test_biomasses_norm>80)]
    else:
